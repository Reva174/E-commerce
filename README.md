...
## Milestone 21:
We have create address form in frontend page. We have also create an state that will store input address. We have also implemented the logic where we click on add address in profile it should navigate to this form page.
...
## Milestone 26:
n this milestone we have created an endpoint of my order.
